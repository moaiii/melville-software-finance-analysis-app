...
export default (meta) => {
   ...
   */
  const taxDataPoints = incomeAmountIncrementsArray
    .map((_incomeAmount) => {
   ...
   * Data points
   */
  const dividendTax = taxDataPoints
    .map((datapoint, index) => {
      return {
